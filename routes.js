...
//var assignments = require('./controllers/assignments');
  ...
  app.get('/api/countries', countries.jsonList);
  app.get('/api/:country', countries.jsonCountry);
  app.get('/countries/:id', countries.findById);
  app.post('/countries/add', countries.add);
  app.post('/countries/update/:id', countries.update); 
